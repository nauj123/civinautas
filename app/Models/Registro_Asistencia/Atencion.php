...
class Atencion extends Model
{
    ...
    */
    ...
    public function getEncabezadoConsultaMensual($id_grupo,$id_mes) {
        $informacion = Atencion::select(Atencion::raw("Pk_Id_Atencion, DATE_FORMAT(DT_Fecha_Atencion, '%d/%m/%Y') AS 'DT_Fecha_Atencion', descripcion, COALESCE(VC_Tematica, '') AS 'VC_Tematica'"))
        ->join("parametro_detalle", "id_parametro_detalle", "=", "IN_Modalidad")
        ->where([
          ['Fk_Id_Grupo', $id_grupo],
